<!-- Modal -->
<div class="modal fade" id="editkategori{{ $data->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
        <form action="/edit_kategori/{{ $data->id }}" method="post">
            @csrf
            @method('PUT')
